  ...
  public: {
    Tables: {
      ...
      academia_opening_hours: {
        ...
        Relationships: [
          {
            foreignKeyName: "academia_opening_hours_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "academia_profiles"
      ...
      academia_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "academia_profiles_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: true
            referencedRelation: "organizations"
            referencedColumns: ["id"]
