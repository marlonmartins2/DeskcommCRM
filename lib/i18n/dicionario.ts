...
export const DICIONARIO: Traducoes = {
  ...
  "Informações da unidade": { es: "Información del establecimiento" },
  "Cadastre os dados oficiais usados pela equipe e pela IA no atendimento.": { es: "Registra los datos oficiales que usan el equipo y la IA durante la atención." },
  "Atualizar informações": { es: "Actualizar información" },
  "O funcionamento abaixo representa a semana regular. Feriados, recessos e exceções precisam de confirmação humana.": { es: "El horario indicado representa una semana regular. Los feriados, recesos y excepciones requieren confirmación humana." },
  "Administradores e gestores podem editar estas informações.": { es: "Los administradores y gestores pueden editar esta información." },
  "Não foi possível atualizar as informações. Os dados exibidos podem estar desatualizados.": { es: "No se pudo actualizar la información. Los datos mostrados pueden estar desactualizados." },
  "Carregando informações…": { es: "Cargando información…" },
  ...
  "Fechamento de": { es: "Cierre del" },
  "Regras e orientações": { es: "Reglas y orientaciones" },
  "Use texto livre somente para orientações públicas que podem ser informadas ao cliente.": { es: "Usa texto libre solamente para orientaciones públicas que se puedan comunicar al cliente." },
  "Alterações não salvas.": { es: "Cambios sin guardar." },
  "Salvar informações": { es: "Guardar información" },
  "Informações salvas.": { es: "Información guardada." },
  "Não foi possível salvar as informações.": { es: "No se pudo guardar la información." },
  "Não foi possível confirmar a gravação. Recarregue para conferir antes de tentar novamente.": { es: "No se pudo confirmar el guardado. Recarga para comprobarlo antes de volver a intentarlo." },
  "Confira os dados informados.": { es: "Revisa los datos ingresados." },
  "Informe um horário no formato HH:mm.": { es: "Introduce una hora en el formato HH:mm." },
  "O fechamento deve ser posterior à abertura no mesmo dia.": { es: "El cierre debe ser posterior a la apertura del mismo día." },
  "Informe um e-mail válido.": { es: "Introduce un correo electrónico válido." },
  "Informe um fuso horário válido.": { es: "Selecciona una zona horaria válida." },
  "Informe no máximo um período por dia.": { es: "Indica como máximo un período por día." },
  "Estas informações foram alteradas. Recarregue a página antes de salvar novamente.": { es: "Esta información fue modificada. Recarga la página antes de volver a guardar." },
  "Confira os dados e os horários informados.": { es: "Revisa los datos y los horarios ingresados." },
  "Você não tem permissão para salvar estas informações.": { es: "No tienes permiso para guardar esta información." },
  "Não foi possível carregar as informações da academia.": { es: "No se pudo cargar la información del gimnasio." },
  "Organize a grade, os cadastros e as informações da sua academia.": { es: "Organiza el horario de clases, los registros y la información de tu gimnasio." },
